...
export default function Profile() {
  return (
    <div className="col-span-3 grid grid-cols-8 gap-5 border border-[#222222] rounded-xl bg-[#111111] p-5">
      <div className="col-span-3 flex flex-col gap-3 items-center border-r-2 border-[#222] pr-5">
        <Image
          alt="profile_picture"
      ...
      <div className="flex flex-col col-span-3 border-r-2 border-[#222] gap-5">
        ...
        <p className="text-justify pr-5">
          Hi, I&apos;m Simone Roy, a recent Information Technology graduate with
          strong foundation in web development and programming and hands-on
